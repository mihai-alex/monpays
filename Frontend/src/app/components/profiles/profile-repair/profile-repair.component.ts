...
@Component({
  selector: 'app-profile-repair',
  templateUrl: './profile-repair.component.html',
  styleUrls: ['./profile-repair.component.scss'],
})
export class ProfileRepairComponent implements OnInit {
  ...
  repairProfile() {
    this.profileService.repairProfile(this.profile).subscribe(
      (data) => {
